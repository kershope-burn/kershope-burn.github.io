              ...
              >
                <Tab eventKey="goals" title="Goals">
                  <ListGroup className="portfolio-text">
                    <ListGroup.Item>Inform and educate myself on personal digital security and privacy and what is reasonably possible to improve these.</ListGroup.Item>
                    <ListGroup.Item>Improve these aspects by exploring alternative service providers, operating systems, and network hardening.</ListGroup.Item>
                    <ListGroup.Item>Balance security and privacy with convenience.</ListGroup.Item>
                  </ListGroup>
                </Tab>
                ...
                <Tab eventKey="outcome" title="Outcome">
                  <ListGroup className="portfolio-text">
                    <ListGroup.Item>Well-known service providers that rely on extensive data collection have been replaced with trusted (sometimes paid) alternatives.</ListGroup.Item>
                    <ListGroup.Item>Advertisements have been removed from day-to-day browsing in my home network on all devices and within all applications.</ListGroup.Item>
                    <ListGroup.Item>The home network has been secured against opportunistic attacks.</ListGroup.Item>
                    <ListGroup.Item>Requests to smart devices on the home network now stay within the home network through use of open source software.</ListGroup.Item>
                    <ListGroup.Item>Extensive network hardening and use of open source router firmware proved a step too far in introducing significant inconvenience.</ListGroup.Item>
                  </ListGroup>
                </Tab>
              </Tabs>
            </Col>
